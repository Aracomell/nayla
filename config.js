...
global.mods = ['6289504231588'] // Want some help?
global.prems = JSON.parse(fs.readFileSync('./src/premium.json')) // Premium user has unlimited limit
global.DeveloperMode = 'false' // true or false
global.linkGC = ['https://chat.whatsapp.com/JgFOfu182li7kG6dlKcwzD']
global.packname = 'Vinn-B0TZ'
global.author = 'Kvnn'
global.multiplier = 36 // The higher, The harder levelup
global.sessionName = 'Vinn' // The Session name behind the .json example is nayla.json
global.mesreport = 50
global.botname = 'Vinn-BOTZ'
